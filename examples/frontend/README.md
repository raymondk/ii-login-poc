...
Run the `test-flow.sh` script to simulate a cli and see the delegation printed out.

Open the frontend at:
```
http://<frontend_canister_id>.localhost:8000/cli-login?public_key=BASE64KEY&callback=http://127.0.0.1:PORT/callback
```
