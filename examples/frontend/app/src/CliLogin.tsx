...
import { parseCliLoginParams, performCliLogin, type Step } from '@icp-sdk/cli-auth';
	...
	return (
		<main className="page">
			<section className="panel">
				...
				{step === 'ready' && (
					<>
						<p className="subtitle">Sign in with Internet Identity to authorize the CLI.</p>
				...
				{step === 'signing-in' && <p className="subtitle">Waiting for Internet Identity...</p>}

				{step === 'sending' && <p className="subtitle">Sending delegation to CLI...</p>}

				{step === 'finished' && <p className="subtitle">Done! You can close this window.</p>}
